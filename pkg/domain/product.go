...
// this for a specift variant of product like(lakme-lipstick-liquid-color)
...
type ProductCategory struct {
	...
	ProductCategory   *ProductCategory // self join for sub category
...
type VariationOption struct {
	...
	Variation   *Variation
	Value       string `json:"value" gorm:"not null"` // the variations value like blue/XL
}
